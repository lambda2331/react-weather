...
const AddCity: React.FC = () => {
  ...
  const handleCityNameUpdate = (event: ChangeEvent) => {
    setCityName((event.target as HTMLInputElement).value)
  }
  ...
  return (
    <div>
      <StyledButton size="small" onClick={openModal} disabled={false}>
        <AddIcon />
      </StyledButton>
